...
const Products = ({}) => {
  ...
  // const productData = DetailData.items[productId];
  const productData = DetailData.find(item => item.id === productId); 
  const { image, title, price, currency, rating, text } = productData;
            ...
            <div className="col-lg-6">
              <div className="sb-product-description sb-mb-90">
                <div className="sb-price-frame sb-mb-30">
                  <h3>{title}</h3>
                  <div className="sb-price"><sub>{currency}</sub> {price}</div>
                </div>
                <ul className="sb-stars sb-mb-25">
                  ...
                  <li><span>({rating} ratings)</span></li>
                </ul>
